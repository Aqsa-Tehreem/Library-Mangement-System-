...
if(isset($_POST['submit']) )
{
      ...
      $sql = "INSERT INTO author(a_fname,a_lname) VALUES (?,?)";
      $stmt= $con->prepare($sql);
      $stmt->execute([$firstname,$lastname]);
      echo "<script>alert('Author Added successfully')</script>";
      header( "Refresh:1; url=addauthor.php", true, 303);
  }
...
<div style="background-color: #5D001E;"><br><br>
    ...
    <form action="addauthor.php" method="post" enctype="multipart/form-data">
    	<center><h1 style="color: #5D001E; font-family: 'Raleway',sans-serif; font-size: 40px; font-weight: 700; line-height: 40px; margin: 0 0 24px; text-align: center; text-transform: uppercase;">ADD AUTHOR</h1></center><br>
        <div class="container">
