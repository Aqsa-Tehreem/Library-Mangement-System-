                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <br>
                                    <p class="card-text">Make sure to clear all your pending dues. Submit on time to avoid fines.</p>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <br>
                                    <p class="card-text">View list of books you have already borrowed. Report incase of any issue.</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img class=" img-fluid" src="images/book.png" style="width:200px;height:150px" alt="card image" alt="card image"></p>
                                    
                                    <a href="books.php" class="btn btn-primary btn-block btn-sm" style="border-radius: 40px; background-color: #5D001E;  padding: 10px 20px; ">Explore Books</a>
                                    <br>
                                    <p class="card-text">Search books to borrow and read. We have an exciting collection.</p>
                                </div>
                            </div>
                        </div>
