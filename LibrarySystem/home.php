...
Login to your account now or If you're new, Register <a href="home.php#signup" style="color: #5D001E;">here</a></p>
<a href="home.php#aboutus" type="button" class="btn btn-primary" style="border-radius: 40px; background-color: #5D001E; padding: 10px 40px;">Learn more</a><br><br>
</p>
<br>
...
<div class="col-lg-6" id="login">
    ...
    <form action="student_login.php" method="post">
        ...
        <input type="submit" class="btn btn-primary btn-block btn-lg" name="submit" style="border-radius: 40px; background-color: #5D001E; padding: 10px 40px;" value="Login">
         <br><div class="text-center small">Don't have an account? <a href="home.php#signup" style="color: #5D001E;">Sign up</a></div>              
    </form>			
</div>
 </div>
</div>
